...
def four(arg1):
	...
	#answer2 = 0
	#answer3 = 0
	#newnumber= int(list[i])
	#answer1 = list[1]
	#for i in range(len(list[1]):
	#	answer1 = answer1+answer1[i]
	#for i in range(len(list[2]):
	#	answer2 = answer2+answer2[i]
	#for i in range(len(list[1]):
	#	answer3 = answer3+answer3[i]
...
def six(input):
	...
	for i in range(len(input)):
		if input[(i):(i+1)] == "ie":
			if input[(i-1):(i+1)] == "cie":
				return False
			elif input[(i-1):(i+2)] != "cie":
				return True

		if input[(i):(i+1)] == "ei":
			if input[(i-1):(i+1)] == "cei":
				return True
			elif input[(i-1):(i+2)] != "cei":
				return False
